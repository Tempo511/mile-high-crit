...
export default {
  ...
  brt: { count: 6, speed: 8.5, lat: 2.0, tMax: 0.7295, route: '15' },
  ...
  spline: [
    ...
    [-496,0, 12],[-488,0,-12],
    /* long cool-down: coast NE onto 14th toward Lincoln, ending at the
       finish festival (chute barrier + crowds) — no more dead-end concrete */
    [-474,0,-32],[-452,0,-44],[-424,0,-48]
  ],
  finishT: 0.8924,                   // the checkered line at the west steps


  boostPads: [0.1309, 0.4115, 0.7108],
  itemBoxes: { at: [0.0842, 0.2338, 0.3835, 0.5331, 0.6827], offsets: [-2.6, 0, 2.6] },

  callouts: [
    { t:0.0187,  label:'THE BLUEBIRD' },
    { t:0.2048, label:'CITY PARK ESPLANADE' },
    { t:0.2824, label:"PETE'S KITCHEN" },
    { t:0.3741,  label:'THE OGDEN' },
    { t:0.4199, label:'THE FILLMORE' },
    { t:0.5032, label:"TOM'S DINER" },
    { t:0.6285, label:'CATHEDRAL BASILICA' },
    { t:0.7323, label:'BROADWAY' },
    { t:0.7791, label:'CAPITOL GROUNDS' },
    { t:0.8698,  label:'THE WEST STEPS' }
  ],
  ...
  props: [
    ...
    { type:'parkSign', t:0.6126, side:-1, text:'CATHEDRAL BASILICA', w:7.4 },
    ...
    { type:'parkSign', t:0.2357, side:-1, faceT:0.2104, text:'CARLA MADISON REC', w:6.6, bg:'#4a3a32' },
    { type:'parkSign', t:0.2076, side:-1, text:'EAST HIGH SCHOOL', w:7 },
    ...
    { type:'parkedBus', t:0.2142, side:-1, school:true },
    ...
    /* the cool-down chute: crowds line the coast-out, checkered wall ends it */
    { type:'crowd', x:-452, z:-33, spread:7, count:7 },
    { type:'crowd', x:-436, z:-60, spread:7, count:6 },
    { type:'crowd', x:-468, z:-52, spread:5, count:4 },
    { type:'endBarrier', x:-416, z:-49, ry:1.71, w:18, text:'MILE HIGH CRIT' },
    /* Capitol Hill proper: lawn blocks + a real grid so the houses south
       of the Capitol stop floating on bare concrete */
    { type:'lawn', x:-450, z:185, r:62, scale:[1.15,1.2] },
    { type:'street', width:5, y:0.018, closed:false, points:[[-420,0,112],[-420,0,255]] },
    { type:'street', width:5, y:0.018, closed:false, points:[[-470,0,112],[-470,0,255]] },
    { type:'street', width:5, y:0.018, closed:false, points:[[-520,0,190],[-300,0,190]] },
    { type:'streetName', text:'GRANT ST',    x:-420, z:150, ry:Math.PI/2, len:12 },
    { type:'streetName', text:'SHERMAN ST',  x:-470, z:150, ry:Math.PI/2, len:13 },
    { type:'streetName', text:'E 13TH AVE',  x:-400, z:190, len:13 },
    /* continue the sprawl's 14th Ave line across the lawn (it draws lower) */
    { type:'street', width:5, y:0.018, closed:false, points:[[-525,0,140],[-375,0,140]] },
    { type:'streetName', text:'E 14TH AVE',  x:-440, z:140, len:13 },
    ...
    { type:'trafficSignal', t:0.0991, side:1 },
    { type:'crosswalk', t:0.0991 },
    { type:'trafficSignal', t:0.3647, side:-1 },
    { type:'crosswalk', t:0.3647 },
    { type:'trafficSignal', t:0.4994, side:1 },
    { type:'crosswalk', t:0.4994 },
    { type:'trafficSignal', t:0.6322, side:-1 },
    { type:'crosswalk', t:0.6322 },
    { type:'trafficSignal', t:0.7323, side:1 },
    { type:'crosswalk', t:0.7323 },

    /* ---------- BRT: median stations + the famous construction ---------- */
    { type:'brtStation', t:0.1263 },
    { type:'brtStation', t:0.3367 },
    { type:'brtStation', t:0.5612 },
    { type:'constructionZone', t0:0.145, t1:0.1824, side:1 },
    { type:'constructionZone', t0:0.4442, t1:0.4817, side:-1 },
    { type:'constructionZone', t0:0.6126, t1:0.65, side:1 },
    { type:'parkSign', t:0.1263, side:1,  text:'ROAD WORK AHEAD', w:5.4, bg:'#e8622d', fg:'#1a1423' },
    { type:'parkSign', t:0.4255, side:-1, text:'ROAD WORK AHEAD', w:5.4, bg:'#e8622d', fg:'#1a1423' },
    { type:'parkSign', t:0.5939, side:1,  text:'ROAD WORK AHEAD', w:5.4, bg:'#e8622d', fg:'#1a1423' },

    /* ---------- the gauntlet: parked cars + buses in the lane ---------- */
    { type:'parkedCars', t0:0.0374, t1:0.0842, side:-1, count:5 },
    { type:'parkedCars', t0:0.1403, t1:0.1871, side:-1, count:5 },
    { type:'parkedCars', t0:0.2899, t1:0.346, side:-1, count:6 },
    { type:'parkedCars', t0:0.4302, t1:0.4863, side:1,  count:4 },
    { type:'parkedCars', t0:0.5237, t1:0.5799, side:-1, count:6 },
    { type:'parkedCars', t0:0.6547, t1:0.7014, side:1,  count:4 },
    { type:'parkedBus', t:0.173, side:1 },
    { type:'parkedBus', t:0.4022,  side:-1, route:'15L' },
    { type:'parkedBus', t:0.5986,  side:1 },
    ...
    { type:'colfaxWall', t0:0.0047, t1:0.7248 },
    ...
    /* ---------- event dressing ---------- */
    { type:'banners', at:[
      { t:0.0094, text:'MILE HIGH CRIT', bg:'#4b2d5e', fg:'#ffd166', side:1 },
      { t:0.2553,  text:'GO GO GO!',      bg:'#c75146', fg:'#f5e9d0', side:-1 },
      { t:0.5144,  text:'COLFAX OR BUST', bg:'#2e5a8f', fg:'#ffd166', side:1 },
      { t:0.636,  text:'SHOPS OPEN DURING CONSTRUCTION', bg:'#e8622d', fg:'#1a1423', side:-1 },
      { t:0.7482,  text:'THE CAPITOL AWAITS', bg:'#3e5a34', fg:'#ffd166', side:-1 },
      { t:0.975,   text:'FINISH FESTIVAL',   bg:'#4b2d5e', fg:'#ffd166', side:1 }
    ]},
    { type:'parkSign', t:0.1665, side:1,  text:'PED XING', w:4, bg:'#d9a520', fg:'#1a1423' },
    { type:'parkSign', t:0.3694, side:-1, text:'PED XING', w:4, bg:'#d9a520', fg:'#1a1423' },
    { type:'parkSign', t:0.6032, side:1,  text:'PED XING', w:4, bg:'#d9a520', fg:'#1a1423' },
  ...
  pedestrians: { zones: [
    { t:0.2198, span:0.03, count:4 },
    { t:0.4209,  span:0.03, count:4 },
    { t:0.6547,  span:0.03, count:3 }
  ]},

  /* geese hold the Esplanade */
  gaggles: [
    { t:0.2011, count:4, spread:8 },
