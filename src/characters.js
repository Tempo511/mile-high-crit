...
export const ROSTER = [
  /* mascot tier */
  { id:'magpie',   name:'MAGPIE',      torso:0x1a1423, helmet:0xf5e9d0, base:18.4, amp:1.6, ph:0.0 },
  { id:'blucifer', name:'BLUCIFER JR', torso:0x2b4a8f, helmet:0xe84855, base:19.0, amp:1.1, ph:2.1 },
  { id:'yeti',     name:'THE YETI',    torso:0xf5e9d0, helmet:0x5db3c9, base:19.5, amp:2.0, ph:4.2 },

  /* locals tier */
  { id:'stravadad', name:'STRAVA DAD', torso:0xd7f13d, helmet:0xff5c8a,
    base:20.4, amp:0.9, ph:1.2,
  ...
  { id:'gravelbro', name:'GRAVEL BRO', torso:0xb0402f, helmet:0x7a6a3a,
    base:18.8, amp:4.2, ph:5.1,             // wanders onto the grass, doesn't care
    corner:{ grip:0.45 },
